...
INSERT INTO `tbl_cdv` (`cdvID`,`CDVNo`,`payee`,`address`,`chkDate`,`bankID`,`amount`,`chkNO`,`particular`,`transDate`,`status`,`prepBy`,`posted`,`postedBy`,`postedDate`,`approveby`,`auditedBy`,`idperiod`) VALUES 
 ...
 (42,'201606-0070','Charelene Almuete','NHA','2016-06-08',1,10000,'57785','Test Entry','2016-06-09','APR',5,'PEN',NULL,NULL,5,2,NULL);
...
INSERT INTO `tbl_gj` (`JID`,`JVNum`,`transDate`,`prepBy`,`particulars`,`approveBy`,`auditedBy`,`glPOsted`,`status`,`brnch`) VALUES 
 ...
 (15,'201606-0007','2016-06-14',5,'wrwqrwqrwq',NULL,NULL,'PEN','PEN','SMSi'),
 (16,'201606-0008','2016-06-14',5,'ewqewqe',NULL,NULL,'PEN','CAN','SMSi'),
 (17,'201606-0009','2016-06-14',5,'test test twat wtatatata',5,5,'PEN','APR','SMSi'),
 (18,'201606-0010','2016-06-28',5,'esadsads',NULL,NULL,'PEN','PEN','SMSi'),
 (19,'201606-0011','2016-06-28',5,'esadsads',NULL,NULL,'PEN','PEN','SMSi'),
 (20,'201607-0012','2016-07-05',5,'Trynes dot com',NULL,NULL,'PEN','PEN','SMSi'),
 (21,'201607-0013','2016-07-05',5,'hdfhgfh',NULL,NULL,'PEN','PEN','SMSi'),
 (22,'201607-0014','2016-07-05',5,'ewqewe',NULL,NULL,'PEN','PEN','SMSi'),
 (23,'201607-0015','2016-07-05',5,'bbb',NULL,NULL,'PEN','PEN','SMSi'),
 (24,'201607-0016','2016-07-05',5,'ew',NULL,NULL,'PEN','PEN','SMSi'),
 (25,'201608-0017','2016-08-22',5,'ew',NULL,NULL,'PEN','PEN','SMSi'),
 (26,'201608-0018','2016-08-22',5,'ew',NULL,NULL,'PEN','PEN','SMSi'),
 (27,'201608-0019','2016-08-22',5,'test test twat wtatatata',NULL,NULL,'PEN','PEN','SMSi');
...
INSERT INTO `tbl_series` (`idNum`,`numSeries`,`Description`,`ABRV`) VALUES 
 (1,'26','Journal Voucher','JV'),
 (2,'77','Check Disbursement Voucher','CDV'),
...
--
-- Definition of procedure `SP_APVEntries`
--
...
--
-- Definition of procedure `SP_CDVEntries`
--
...
--
-- Definition of procedure `SP_CDVPreview`
--
...
BEGIN
	DROP TEMPORARY TABLE IF EXISTS tbl_tmpPreview;
	CREATE TEMPORARY TABLE tbl_tmpPreview (
		cdvID INT(10),
		CDVNo VARCHAR(20),
		payee VARCHAR(50),
		address VARCHAR(50),
	...
	INSERT INTO tbl_tmpPreview(cdvID,CDVNo,payee,address,chkDate,bankName,chkNo,particular,prepby,appby,audby)
	SELECT cdvID, CDVNo, payee, address, chkDate, bankName, chkNo, particular, prepby, appby, audby FROM
		(SELECT a.cdvID, a.CDVNo, a.payee, a.address,a.chkDate, d.bankName, a.chkNO, a.particular, b.empName AS prepby,
		(SELECT a.empName FROM tbl_employee a LEFT JOIN tbl_useracct b ON a.empID=b.empID LEFT JOIN tbl_cdv c ON b.userID=c.approveby WHERE c.cdvID=id) AS appby,
		(SELECT a.empName FROM tbl_employee a LEFT JOIN tbl_useracct b ON a.empID=b.empID LEFT JOIN tbl_cdv c ON b.userID=c.auditedBy WHERE c.cdvID=id) AS audby
	FROM tbl_cdv a
...
--
-- Definition of procedure `SP_EditCDVEntries`
--
...
--
-- Definition of procedure `SP_JVEntries`
--
